...
const Contact = () => {
  ...
  return (
    <section className="section-padding bg-gradient-to-br from-pool-600 to-aqua-600 relative overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:5551234POOL" className="text-aqua-200 hover:text-white transition-colors">
                    (555) 123-POOL
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:info@aquaclear.com" className="text-aqua-200 hover:text-white transition-colors">
                    info@aquaclear.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/90">1234 Poolside Drive<br />Miami, FL 33101</p>
                </div>
              </motion.div>
