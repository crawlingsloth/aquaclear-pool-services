...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-pool-600 to-aqua-600 overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white section-padding max-w-4xl mx-auto">
        ...
        >
          AquaClear
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-aqua-200 to-pool-200">
            Pool Services
          </span>
        </motion.h1>
